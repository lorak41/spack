...
class MofemUsersModules(CMakePackage):
    ...
    variant('modules-manager', default=False, description='Build with modules manager')
    ...
    depends_on('mofem-modules-manager', when='+modules-manager')
    ...
    def cmake_args(self):
        ...
        if '+mofem-modules-manager' in spec:
